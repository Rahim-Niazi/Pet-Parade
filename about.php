    ...
    <section id="header">
        ...
        <section id="about-head" class="section-p1">
            ...
            <div>
                ...
                <marquee backgroundcolor="#CCC" loop="-1" scrollamount="5" width="100%">This is a sample line of text that i wish to check out pay it no heed. Also i move. how cool is that</marquee>
            </div>
        </section>
